    ...
    <Swipeable
      ...
      renderRightActions={() => (
        <Pressable
          ...
          className="mb-3 w-24 items-center justify-center rounded-r-3xl bg-high"
        >
          <Text className="font-semibold text-white">Delete</Text>
        </Pressable>
      )}
    >
      <Pressable onPress={onPress} className="mb-3 flex-row items-center rounded-3xl bg-cream px-3 py-3">
        <Image
